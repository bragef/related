...
familysim <- function(freqs, ninds = 100L) {
  ...
  sim_matrix <- .External("family_sim", ninds, nloci, nalleles, alleles, frequencies)
...
# simulations, and then compares the two
...
grouprel <- function(genotypes, estimatorname, usedgroups, iterations) {
